...
__all__ = ['cifarresnet18', 'cifarresnet34', 'cifarresnet50', 'cifarresnet101', 'resnet18', 'resnet50', 'resnet101']
...
class CIFAR_ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes, bias=True):
...
def cifarresnet101(pretrained=False, **kwargs):
